...
export const blogDatabase: BlogData[] = [
  ...
  },
  {
    ...
    excerpt:
      "Mixed performance across IT and banking sectors as global uncertainty weighs on investor sentiment.",
    content: `
    <p>The Indian stock market has delivered outstanding returns in 2025, with the Sensex crossing multiple psychological milestones.</p>

    <p>Banking and IT sectors have led the rally, supported by strong domestic inflows.</p>

    <img 
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD5ihSsNh3nVI-FgI0pLAgbMeSZ2ANiB_dvw&s"
      alt="Indian Stock Market"
      style="max-width:100%; border-radius:12px; margin:20px 0;"
    />

    <p>Year-end trading shows continued strength with broad-based participation.</p>
    `,
  },
  {
    country: "Japan",
  ...
  },
  {
    ...
    excerpt:
      "Reserve Bank's supportive measures lift banking sector and broader market sentiment.",
    content:
      "The Reserve Bank of India's supportive policy stance provided a boost to financial stocks today. Banking indices surged on expectations of improved lending growth and margin expansion. Private banks outperformed public sector banks on improved efficiency metrics and digital banking adoption.\n\nThe broader market also benefited from the positive momentum in financials, which form a significant weightage in benchmark indices. Liquidity conditions remained ample with system repo rates staying soft. Non-banking financial companies also showed strength, reflecting improved credit market conditions and appetite for higher-yielding assets.",
  },
  {
    country: "Japan",
    date: "2025-01-23",
    ...
    excerpt:
      "Strong Q3 results from major corporations support continued strength in Japanese equities.",
    content:
      "Japanese stocks extended their winning streak on positive earnings surprises from major corporations. Industrial conglomerates posted strong results reflecting robust global demand for manufactured goods. The export-led recovery continued to benefit from the weak yen backdrop.\n\nRetail participation also picked up with individual investors showing renewed interest in equity investments. Market optimism reflected in rising breadth indicators and increasing participation across sectors. Morning trading sessions saw particularly strong buying interest, suggesting positive momentum is building.",
  },
  {
    country: "Crypto",
    date: "2025-01-23",
